...
export function BehanceSection() {
  return (
    <section id="portfolio" className="bg-foreground py-24 px-10 scroll-mt-24">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-sm font-semibold tracking-[0.2em] uppercase text-orange mb-2">Reconhecido no Behance</p>
          <div className="w-12 h-1 bg-orange rounded-full mx-auto mb-5" />
          <h2 className="text-4xl font-extrabold text-background leading-tight tracking-tight mb-4">Identidades que já viraram referência</h2>
