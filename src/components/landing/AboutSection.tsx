...
export function AboutSection() {
  return <section className="py-16 md:py-24 md:min-h-screen md:flex md:items-center bg-background px-8 sm:px-12 md:px-16 lg:px-6">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          duration: 0.7
            ...
            <div className="aspect-[4/5] bg-gradient-to-br from-muted to-muted/50 rounded-2xl overflow-hidden relative">
              ...
              <img src={adsonPhoto} alt="Adson Barros - Estrategista de marca" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          ...
          delay: 0.2
            ...
            <div className="space-y-3 sm:space-y-4 text-foreground/80 leading-relaxed text-xs sm:text-sm md:text-base text-justify border-8">
              <p>
